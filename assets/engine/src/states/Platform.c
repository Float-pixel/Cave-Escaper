...
//hopefully below this means i will walk

  player.animate = (projectilestand && pl_vel_x != 0) || (grounded && pl_vel_x != 0) || (on_ladder && pl_vel_y != 0);
